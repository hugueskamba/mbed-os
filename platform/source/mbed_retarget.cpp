...
#if   CONSOLE_FLOWCONTROL == CONSOLE_FLOWCONTROL_RTS
    set_flow_control(MinimalSerial::RTS, STDIO_UART_RTS, NC);
#elif CONSOLE_FLOWCONTROL == CONSOLE_FLOWCONTROL_CTS
    set_flow_control(MinimalSerial::CTS, NC, STDIO_UART_CTS);
#elif CONSOLE_FLOWCONTROL == CONSOLE_FLOWCONTROL_RTSCTS
    set_flow_control(MinimalSerial::RTSCTS, STDIO_UART_RTS, STDIO_UART_CTS);
#endif
}
