...
public:
    ...
    */
     ...
     *UARTSe data can be written, and non-blocking set, write partial
     *UARTS
     ...
     *
     *  @return         1 to indicate that the file is a terminal
     */
    virtual int isatty();
     ...
     *
     *  @return             zero to indicate on success
     */
...
#else
    CircularBufferBase<char> _rxbuf;
    CircularBufferBase<char> _txbuf;
#endif
